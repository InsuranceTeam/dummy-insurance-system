...
public class CmTcActuarial {
    ...
    private int       hospitalization_money;   //入院日額
    ...
    public int getHospitalization_money() {
        return hospitalization_money;
    }
    public void setHospitalization_money(int hospitalization_money) {
        this.hospitalization_money = hospitalization_money;
    }
}
