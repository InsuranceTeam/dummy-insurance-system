...
@Component
public class WcKInputValidation implements Validator{
    ...
    public void validate(Object target, Errors errors) {
        WcKInput wcKInput = (WcKInput)target;

        //解約処理に対するチェック
        if(wcKInput.getSelect_cancel().equals("1")) {

            //解約日の暦日チェック
            String cancel_date_str = wcKInput.getCancel_date();
            ...
            if(cancel_date_check_flg){
                ...
                LocalDate start_date  = LocalDate.parse(wcKInput.getWcSReference().getContract_start_date(),
